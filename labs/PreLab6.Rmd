...
```{r}
maryland_voters <- maryland_population |> left_join(county_voters_2022, 
join_by("COUNTY"))
```
...
```{r}
maryland_population_with_voters <- maryland_population |> left_join _by(county_voters_2022)
```
