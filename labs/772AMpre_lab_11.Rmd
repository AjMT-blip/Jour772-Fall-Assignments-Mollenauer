...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer: The sentiments that appeared upon running this code seemed mostly identified correctly by R. I noticed a few that seemed more neutral or context-dependent but that were assigned positive or negative. One example is "critical," which R identified as negative. With respect to the definition regarding giving tough feedback, it seems there's room for interpretation, as one could argue that it's good when someone is critical in their feedback if it's teaching you a skill or how to be better in an area. Or, in the context of "critical" meaning someone is a critical addition to the team or staff, or group, etc., "critical" is clearly positive because it establishes that that person is valuable and needed due to positive metrics such as skill set, experience, talent, etc. In short, what I'm noticing is that R at least seems to understand the sentiments of basic terms where there is little, if any, room for interpretation, but with more nuanced words it seems R lacks that pinpoint ability to identify appropriately by sentiment. That issue seems to be because R recognizes any given word as having just one general definition.**
